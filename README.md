Mods done for Jags dev env
===========================
Commented lots of unwanted apps and added few new apps in apps.sh
Added Postgres installation with auto setups
Commented some unwanted mac defaultsettings commands
Added git configs from nicolashrey
Added npm update command
Added few brew packages like imagemagick, android-sdk, redis, sqlite, python, qt, ios-sim
Added amazon awscli
Removed xquartz mysql mariadb php56
Added Homebrew cask options
Added path settings to .zshrc and .bashrc both
Added guide comments if you get permission errors on /usr/local folder
Ruby is set to 2.2.2
Added few global npm packages like ionic, cordova, ios-deploy
Removed font installtions
Added a settings.txt file for sublime text editor settings
